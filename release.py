...
def update_readme(version: str, code_quality: str = None) -> None:
    ...
    pattern = re.sub(
        "img.shields.io/badge/version-\\d+\\.\\d+\\.\\d+",
    ...
    if code_quality:
        ...
        pattern = re.sub(
            "img.shields.io/badge/code_quality-[A-Z]-[0-9A-Z]{6}\\?",
            "img.shields.io/badge/code_quality-{}-{}?".format(code_quality, quality_color),
            pattern,
        )
...
def update_pyproject(version: str) -> None:
    ...
    pattern = re.sub(
        'version = "\\d+\\.\\d+\\.\\d+"', 'version = "{}"'.format(version), pyproject_content
    )
...
def update_makefile(version: str) -> None:
    ...
    pattern = re.sub("version = \\d+\\.\\d+.\\d+", "version = {}".format(version), makefile_content)
